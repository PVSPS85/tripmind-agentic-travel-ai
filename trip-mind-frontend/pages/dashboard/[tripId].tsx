        ...
        {extraActivities.length > 0 && (
          <motion.div variants={itemVariants} className="pt-8">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2 mb-2">
              <span>🎯</span> Extra activity add-ons
            </h2>
            <div className="bg-teal-50 border border-teal-100 dark:bg-teal-900/20 dark:border-teal-900/50 rounded-xl p-4 mb-4 text-teal-800 dark:text-teal-300 text-xs font-medium flex items-start gap-2">
              <span>✨</span> <p>None of these repeat your itinerary. These are optional add-ons — nearby experiences, rainy-day fallbacks, and age-specific detours.</p>
            </div>
